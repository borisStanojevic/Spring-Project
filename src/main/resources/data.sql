...
VALUES            ("Gledam Drinu njene vode plave ...", "2018/01/01", "SOKANTNO", "mitar123", "default_post_photo.png", 10, 1),
				  ...
				  ("Duge noge za igranje vitko telo za pevanje ...", "1992/05/16", "SOK I NEVERICA !", "saban123", "default_post_photo.png", 1, 1),
				  ("Palim zadnju cigaretu \n idem u beskraj s njom...", "2001/09/08", "ODE MITAR IZ BOSNE", "mitar123", "default_post_photo.png", 2, 0),
				  ("Luda za tobom sta se tu moze \n kad jos te cuvam ispod koze", "2003/01/01", "STA DA VAM KAZEM", "saban123", "default_post_photo.png", 3, 0);
				  
INSERT INTO tags (tag_name) VALUES ("kornjace"), ("delfini"), ("aligator"), ("orka"), ("panda");

INSERT INTO roles (role_role) VALUES ("ROLE_ADMIN"), ("ROLE_PUBLISHER"), ("ROLE_COMMENTATOR");

INSERT INTO user_role VALUES ("mitar123", "ROLE_ADMIN"), ("saban123", "ROLE_PUBLISHER"), ("brena123", "ROLE_COMMENTATOR");